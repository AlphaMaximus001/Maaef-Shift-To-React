...
export default function ExpertisePage() {
  ...
  const activeService = selectedIdx !== null ? EXPERTISE_DATA[selectedIdx] : null;

  return (
    <>
      <div className="noise-overlay" />

      <main id="expertise-page-wrapper" className="relative w-full min-h-screen overflow-x-hidden bg-black select-none">
        ...
        >
          ...
          {activeService && (
            <>
              ...
              <Image
                ...
                alt="Selected expertise background"
                fill
          ...
          <div className="page-label">Services — Maaef Media House</div>
        </section>
